...
function scene:create( event )
  ...
  --set the color of the pannel
   ...
   --create lose background
   loseBackground = display.newImageRect("Images/LoseBack.png", display.contentWidth+150, display.contentHeight+200)
   sceneGroup:insert(loseBackground)
   loseBackground.isVisible = false
   --set the position of the lose background
   loseBackground.x = 520
   loseBackground.y = 400

   --create lose background
   winBackground = display.newImageRect("Images/WinBack.png", display.contentWidth+150, display.contentHeight+200)
   sceneGroup:insert(winBackground)
   winBackground.isVisible = false
   --set the position of the lose background
   winBackground.x = 520
   winBackground.y = 400
